...
public class ISO19115_3_2018_DEECA_SchemaPlugin
    ...
    static {
        allNamespaces = ImmutableSet.<Namespace>builder()
            ...
            .add(ISO19115_3_2018_DEECA_Namespaces.CIT)
    ...
    private AssociatedResource elementAsAssociatedResource(Element ref) {
        ...
        String title = ref.getAttributeValue("title", ISO19115_3_2018_DEECA_Namespaces.XLINK, "");
        String url = ref.getAttributeValue("href", ISO19115_3_2018_DEECA_Namespaces.XLINK, "");
    ...
    private AssociatedResource metadataRefAsAssociatedResource(Element sibling) {
        Element ref = (Element) sibling.getChild("metadataReference", ISO19115_3_2018_DEECA_Namespaces.MRI);
        String sibUuid = ref.getAttributeValue("uuidref");

        String associationType = sibling.getChild("associationType", ISO19115_3_2018_DEECA_Namespaces.MRI)
            .getChild("DS_AssociationTypeCode", ISO19115_3_2018_DEECA_Namespaces.MRI)
            .getAttributeValue("codeListValue");

        String initType = "";
        final Element initiativeTypeEl = sibling.getChild("initiativeType", ISO19115_3_2018_DEECA_Namespaces.MRI);
